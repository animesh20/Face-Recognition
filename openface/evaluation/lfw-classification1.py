...
def plotTrainingTime(workDir, largeFont, 
    ...
    if largeFont:
        ...
        plt.legend(loc='upper center', bbox_to_anchor=(0.5, 1.27), ncol=1,
                   fancybox=True, shadow=True, fontsize=16)
    else:
        ax.set_position([box.x0, box.y0 + 0.05, box.width, box.height * 0.85])
        plt.legend(loc='upper center', bbox_to_anchor=(0.5, 1.25), ncol=1,
...
def plotPredictionTime(workDir, largeFont, 
    ...
    if largeFont:
        ...
        plt.legend(loc='upper center', bbox_to_anchor=(0.5, 1.45), ncol=1,
                   fancybox=True, shadow=True, fontsize=16)
    else:
        ax.set_position([box.x0, box.y0 + 0.05, box.width, box.height * 0.77])
        plt.legend(loc='upper center', bbox_to_anchor=(0.5, 1.37), ncol=1,
                   fancybox=True, shadow=True)
